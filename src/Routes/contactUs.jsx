    ...
    <React.Fragment>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          We would love to hear from you! If you have any questions, suggestions, or would like to join our initiatives, feel free to reach out. We are always open to collaborations, partnerships, and new ideas. Let’s work together to create a brighter future!
          <br />
          <br />
